...
ClapTrap::ClapTrap()    {
    _name = "defaultClap";
    initAttribs(10, 10, 0);
    std::cout << "ClapTrap class default constructor called for <" << _name << ">.\n";
}

ClapTrap::ClapTrap(std::string name){
    this->_name = name;
    initAttribs(10, 10, 0);
    std::cout << "ClapTrap class named constructor called for <" << _name << ">.\n";
}
...
ClapTrap::~ClapTrap()   {
    std::cout << "ClapTrap class destructor called and destroyed <" << _name << ">.\n";  }
